...
/// @nodoc
mixin _$HomeState {
  List<Posts> get postList => throw _privateConstructorUsedError;
...
class _$HomeStateImpl implements _HomeState {
  _$HomeStateImpl({final List<Posts> postList = const []})
      : _postList = postList;

  factory _$HomeStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$HomeStateImplFromJson(json);

  final List<Posts> _postList;
  @override
  @JsonKey()
  List<Posts> get postList {
  ...
  @override
  String toString() {
    return 'HomeState(postList: $postList)';
  }
...
abstract class _HomeState implements HomeState {
  factory _HomeState({final List<Posts> postList}) = _$HomeStateImpl;
